...
// source: proto/pbevent/subscribe.proto
...
func (Topic) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e8242542b2af2670, []int{0}
}
...
func (CatalogOp) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_e8242542b2af2670, []int{1}
}

// SubscribeRequest used to subscribe to a topic.
type SubscribeRequest struct {
	// Topic identifies the set of events the subscriber is interested in.
	Topic Topic `protobuf:"varint,1,opt,name=Topic,proto3,enum=event.Topic" json:"Topic,omitempty"`
...
func (*EventBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_e8242542b2af2670, []int{2}
}
...
type ServiceHealthUpdate struct {
	Op                   CatalogOp                   `protobuf:"varint,1,opt,name=Op,proto3,enum=event.CatalogOp" json:"Op,omitempty"`
...
func (*ServiceHealthUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_e8242542b2af2670, []int{3}
}
...
func init() {
	...
	proto.RegisterEnum("event.CatalogOp", CatalogOp_name, CatalogOp_value)
	proto.RegisterType((*SubscribeRequest)(nil), "event.SubscribeRequest")
	proto.RegisterType((*Event)(nil), "event.Event")
	proto.RegisterType((*EventBatch)(nil), "event.EventBatch")
	proto.RegisterType((*ServiceHealthUpdate)(nil), "event.ServiceHealthUpdate")
}

func init() { proto.RegisterFile("proto/pbevent/subscribe.proto", fileDescriptor_e8242542b2af2670) }

var fileDescriptor_e8242542b2af2670 = []byte{
	// 541 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *stateChangeSubscriptionClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (StateChangeSubscription_SubscribeClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StateChangeSubscription_serviceDesc.Streams[0], "/event.StateChangeSubscription/Subscribe", opts...)
	if err != nil {
		return nil, err
	}
...
var _StateChangeSubscription_serviceDesc = grpc.ServiceDesc{
	ServiceName: "event.StateChangeSubscription",
	...
	Metadata: "proto/pbevent/subscribe.proto",
}
